...
{
  var player = GetPlayer();
SheetsSet('COST CENTRE', player.GetVar('section'));
}
...
{
  var player = GetPlayer();
SheetsSet('Staff No.', player.GetVar('number'));
}
...
{
  var player = GetPlayer();
SheetsSet('Score', player.GetVar('SCORE3'));
}

window.Script53 = function()
{
  var player = GetPlayer();
SheetsSet('PASS/FAIL', player.GetVar('pf'));
}
